...
path_root = "/local/scratch/datasets/FullbodySCT/USZ_Data/"
path_all = os.path.join(path_root + "initial data")  # path containing all original CT dicom series + RT struct
