#!/usr/bin/env python3
"""
N-Peaks MRI Intensity Normalization - Batch Processing Script
==============================================================
Run this script in a screen session on the cluster:
    screen -S npeaks
    python run_npeaks_batch.py
    # Detach: Ctrl+A, then D
    # Reconnect: screen -r npeaks

Author: Generated from 34_npeaks.ipynb
...
!!!!!!!!!!
Renname folders for npeaks_analysis 
!!!!!!!!!!
"""
