...
path_normalized_MR = "/local/scratch/datasets/FullbodySCT/USZ_Data/nyul_normalized/"
path_normalized_CT = "/local/scratch/datasets/FullbodySCT/USZ_Data/before_temp/CT_reg/"

# for nn_input_mode in ["2d","pseudo3d"]:
for nn_input_mode in [ "2d"]:
    # # #save in the aligned and not aligned fashion
    path_model = "/local/scratch/datasets/FullbodySCT/USZ_Data/nyul_normalized/2nd_paper_nyul_AIROR_model_test_" + nn_input_mode
    path_pix = "/local/scratch/datasets/FullbodySCT/USZ_Data/nyul_normalized/2nd_paper_nyul_AIROR_pix2pix_test_" + nn_input_mode

    path_excel_final_split = "/local/scratch/datasets/FullbodySCT/USZ_Data/train_test_split.xlsx"
