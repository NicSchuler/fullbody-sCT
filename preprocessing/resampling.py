...
base_path = "/local/scratch/datasets/FullbodySCT/USZ_Data/"
...
path_new_masks_air = base_path + "before_temp/masks_air"
path_new_masks_fat = base_path + "before_temp/masks_fat"
path_new_masks_liver = base_path + "before_temp/masks_liver"
path_new_masks_water_bladder = base_path + "before_temp/masks_water_bladder"
